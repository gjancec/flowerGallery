          ...
          <div className="md:flex justify-center mt-5">
            ...
            >
              ...
              >
                ...
                <input
                  className="my-4 p-2 bg-gray-100 border-2 border-[#4E684B]"
                  type="email"
                  placeholder="Email"
                  name="email"
                  {...register("email", {
                ...
                <button
                  type="submit"
                  className="bg-[#D8608F] rounded-sm font-semibold  hover:bg-red-300 transition duration-500 px-8 py-3 my-4 mx-auto flex items-center"
                >
                  Send
                </button>
              </form>
