    ...
    <section id="gallery" className="pt-48 pb-48">
      ...
      <div className="flex justify-center">
        ...
        >
          {/*ROW 1*/}
          <div
            className="flex justify-center text-center items-center p-10 tracking-widest  bg-[#D8608F]
          ...
          <div
            className="flex justify-center text-center items-center p-10 tracking-widest bg-[#869B6D]
    max-w-[640px] max-h-[640px] text-2xl font-playfair font-semibold"
          >
            BEUTIFULL FLOWERS
          </div>
